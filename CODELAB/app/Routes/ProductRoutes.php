...
class ProductRoutes
{
    public function handle($method, $path)
    {
        ...
        // Jika request method GET dan path mengandung /api/product/{id}
        ...
        // Jika request method PUT dan path mengandung /api/product/{id}
        ...
        // Jika request method DELETE dan path mengandung /api/product/{id}
